 ...
 * 능력 정보의 설명을 표현하는 클래스.
 */
public final class AbilityInfoLore {
    /** 섹션 문자열 목록 */
     ...
     */
    public AbilityInfoLore(@NonNull Section defaultSection, @NonNull NamedSection @NonNull ... sections) {
     ...
     * @param defaultSection 기본 설명 섹션
     */
    public AbilityInfoLore(@NonNull Section defaultSection) {
        this.sections = new String[]{defaultSection.toString()};
    }

    /**
     * 능력 정보 설명의 전체 문자열을 반환한다.
     *
     * <p>Example:</p>
     *
     * <pre>
     ...
     *
     * <pre><code>
     * AbilityInfoLore lore = new AbilityInfoLore(Section
     *     .builder("능력 개요에 대한 내용")
