...
public abstract class ActiveSkillInfo<T extends ActiveSkill> extends SkillInfo<T> {
     ...
     */
    protected ActiveSkillInfo(@NonNull Class<@NonNull T> skillClass, @NonNull String name, @NonNull AbilityInfoLore abilityInfoLore) {
    ...
    /**
     * @see SkillInfo#SkillInfo(Class, String, ItemStack, AbilityInfoLore)
     */
    ActiveSkillInfo(@NonNull Class<@NonNull T> skillClass, @NonNull String name, @NonNull ItemStack itemStack, @NonNull AbilityInfoLore abilityInfoLore) {
