...
public final class NeaceA2Info extends ActiveSkillInfo<NeaceA2> {
    ...
    public static final class SOUND {
        ...
        public static final DefinedSound USE = new DefinedSound(
                new DefinedSound.SoundEffect(Sound.ENTITY_EVOCATION_ILLAGER_CAST_SPELL, 2, 1.5),
                new DefinedSound.SoundEffect(Sound.BLOCK_ENCHANTMENT_TABLE_USE, 2, 1.4),
                new DefinedSound.SoundEffect(Sound.BLOCK_ENCHANTMENT_TABLE_USE, 2, 1.4),
                new DefinedSound.SoundEffect(Sound.ENTITY_ZOMBIE_VILLAGER_CONVERTED, 0.5, 1.4)
        );
    }
}
