...
public abstract class TemporaryEntity<T extends Entity> extends AbstractCombatEntity<T> {
     ...
     */
    protected TemporaryEntity(@NonNull T entity, @NonNull String name, @NonNull Hitbox @NonNull ... hitboxes) {
        super(entity, name, hitboxes);
     ...
     * @param hitboxes      히트박스 목록
     */
    protected TemporaryEntity(@NonNull Class<T> entityClass, @NonNull Location spawnLocation, @NonNull String name, @NonNull Hitbox @NonNull ... hitboxes) {
