...
public abstract class Barrier extends SummonEntity<ArmorStand> implements Damageable {
     ...
     */
    protected Barrier(@NonNull Location spawnLocation, @NonNull String name, @NonNull CombatUser owner, int score, int maxHealth, @NonNull Hitbox hitbox) {
        super(ArmorStand.class, spawnLocation, name, owner, false, false, hitbox);

        this.knockbackModule = new KnockbackModule(this, 2);
        this.statusEffectModule = new StatusEffectModule(this);
        this.damageModule = new DamageModule(this, false, false, false, score, maxHealth);
    }
