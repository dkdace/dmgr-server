...
public abstract class Scuffler extends Combatant {
     ...
     */
    protected Scuffler(@NonNull String name, @NonNull String nickname, @NonNull String skinName, @Nullable Role subRole, @NonNull Species species,
    ...
    private static final class RoleTrait1Info extends TraitInfo<RoleTrait1> {
        ...
        private RoleTrait1Info() {
            super(RoleTrait1.class, "역할: 근접 - 1",
    ...
    private static final class RoleTrait2Info extends TraitInfo<RoleTrait2> {
        ...
        private RoleTrait2Info() {
            super(RoleTrait2.class, "역할: 근접 - 2",
                    new AbilityInfoLore(AbilityInfoLore.Section
    ...
    private static final class RoleTrait2 extends Trait {
        ...
        private void onKill(@NonNull Damageable victim) {
            if (victim.isGoalTarget())
                combatUser.getStatusEffectModule().apply(SPEED, RoleTrait2Info.DURATION);
        }
    }
}
