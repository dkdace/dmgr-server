...
public final class DeltaWeaponInfo extends WeaponInfo<DeltaWeapon> {
    ...
    /** 쿨타임 */
    public static final Timespan COOLDOWN = Timespan.ofSeconds(0.05);
    /** 사거리 (단위: 블록) */
                ...
                new ActionInfoLore(ActionInfoLore.Section
                        ...
                        new ActionInfoLore.NamedSection("연결: 워프 드라이브", ActionInfoLore.Section
                                .builder("바라보는 곳으로 순간이동한 뒤 일정 시간동안 유지되는 일방통행 포탈을 남깁니다. " +
                                        "포탈은 접촉한 대상을 순간이동 시킵니다. 이동 거리에 비례하여 글리치 사용량이 증가합니다.")
                                .addValueInfo(TextIcon.ATTACK_SPEED, Format.TIME, WarpDrive.DURATION.toSeconds())
